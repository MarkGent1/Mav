...
{
    public readonly Mock<HttpMessageHandler> AccountApiClientHttpMessageHandlerMock = new();
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        {
            services.AddRefitClient<IAccountApiClient>()
                .ConfigurePrimaryHttpMessageHandler(() => AccountApiClientHttpMessageHandlerMock.Object);
